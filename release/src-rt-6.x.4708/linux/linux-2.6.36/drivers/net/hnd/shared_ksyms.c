...
extern void ai_dumpregs; EXPORT_SYMBOL(ai_dumpregs);
...
extern void ai_view; EXPORT_SYMBOL(ai_view);
extern void ai_viewall; EXPORT_SYMBOL(ai_viewall);
extern void ai_wrap_reg; EXPORT_SYMBOL(ai_wrap_reg);
extern void otp_dump; EXPORT_SYMBOL(otp_dump);
extern void otp_dumpstats; EXPORT_SYMBOL(otp_dumpstats);
...
extern void _make_gcc_happy_about_unused_variabe_; EXPORT_SYMBOL(_make_gcc_happy_about_unused_variabe_);
...
extern void srom_write_short; EXPORT_SYMBOL(srom_write_short);
...
extern void bcm_format_field; EXPORT_SYMBOL(bcm_format_field);
extern void bcm_format_flags; EXPORT_SYMBOL(bcm_format_flags);
extern void bcm_format_hex; EXPORT_SYMBOL(bcm_format_hex);
extern void bcm_format_ssid; EXPORT_SYMBOL(bcm_format_ssid);
...
extern void pktpool_avail; EXPORT_SYMBOL(pktpool_avail);
...
extern void si_pmu_enb_ht_req; EXPORT_SYMBOL(si_pmu_enb_ht_req);
...
extern void pcicore_dump; EXPORT_SYMBOL(pcicore_dump);
extern void pcicore_dump_pcieinfo; EXPORT_SYMBOL(pcicore_dump_pcieinfo);
...
extern void sb_dumpregs; EXPORT_SYMBOL(sb_dumpregs);
...
extern void sb_view; EXPORT_SYMBOL(sb_view);
...
extern void si_chipid_override; EXPORT_SYMBOL(si_chipid_override);
extern void si_chippkg_set; EXPORT_SYMBOL(si_chippkg_set);
extern void si_chiprev_override; EXPORT_SYMBOL(si_chiprev_override);
...
extern void si_dump_pcieinfo; EXPORT_SYMBOL(si_dump_pcieinfo);
extern void si_dumpregs; EXPORT_SYMBOL(si_dumpregs);
extern void si_epa_4313war; EXPORT_SYMBOL(si_epa_4313war);
extern void si_ercx_init; EXPORT_SYMBOL(si_ercx_init);
...
extern void si_gci_get_chipctrlreg_idx; EXPORT_SYMBOL(si_gci_get_chipctrlreg_idx);
...
extern void si_gci_seci_init; EXPORT_SYMBOL(si_gci_seci_init);
...
extern void si_jtag_ureg_read; EXPORT_SYMBOL(si_jtag_ureg_read);
extern void si_jtag_ureg_write; EXPORT_SYMBOL(si_jtag_ureg_write);
...
extern void si_view; EXPORT_SYMBOL(si_view);
extern void si_viewall; EXPORT_SYMBOL(si_viewall);
...
extern void robo_dump_regs; EXPORT_SYMBOL(robo_dump_regs);

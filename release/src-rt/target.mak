...
export RT-N66U := IPV6SUPP=y HTTPS=y MIPS32=r2 BCM57=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=y \
                  ...
                  USER_LOW_RSSI=y  TIMEMACHINE=n MDNS=n VPNC=y JFFS2LOG=n DROPBOXCLIENT=y \
                  PROXYSTA=y AUTODICT=y DEBUGFS=n \
...
export RT-AC66U := IPV6SUPP=y HTTPS=y MIPS32=r2 BCM57=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=y \
                   ...
                   TIMEMACHINE=n MDNS=n VPNC=y JFFS2LOG=y DUMP_OOPS_MSG=y DEBUGFS=n DROPBOXCLIENT=y \
                   TFAT=n HFS="none" NTFS="paragon" IPSEC=y REPEATER=y DUALWAN=y YANDEXDNS=n DNSFILTER=y
...
export RT-N16 := IPV6SUPP=y  HTTPS=y MIPS32=r2 BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=y MEDIASRV=y \
                 ...
                 USER_LOW_RSSI=y  TIMEMACHINE=n MDNS=n VPNC=y JFFS2LOG=n DEBUGFS=n DROPBOXCLIENT=y \
                 TFAT=n HFS="none" NTFS="paragon" IPSEC=y REPEATER=y DUALWAN=y YANDEXDNS=n DNSFILTER=y
...
export RT-AC68U := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
                   ...
                   DUMP_OOPS_MSG=y LINUX_MTD="32" \
                   TFAT=y HFS="tuxera" NTFS="tuxera" IPSEC=n REPEATER=y DUALWAN=y DNSFILTER=y
export RT-AC68U_V2 := $(RT-AC68U)
export RT-AC69U := $(RT-AC68U)

NORMAL=1
ifeq ($(NORMAL),)
export RT-AC56U := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
                   SAMBA3=y MODEM=y BECEEM=y PARENTAL2=y ACCEL_PPTPD=y TEMPROOTFS=y \
                   WEBDAV=y USB="USB" GRO=y BUILD_NAME="RT-AC56U" PROXYSTA=y LINUX_MTD="32" \
                   DNSMQ=y SHP=y NVRAM_64K=y RTAC56U=y BCMWL6=y BCMWL6A=y TUNEK="n" BCM5301X=y DISK_MONITOR=y \
                   OPTIMIZE_XBOX=y TURBO=y USBEJECT=y ODMPID=y BCM4352_5G=y LANWAN_LED=y \
                   BCMSMP=y LED_ALL=y XHCI=y USBRESET=n SSH=y JFFS2=y USER_LOW_RSSI=y BCMNAND=y \
                   TIMEMACHINE=y MDNS=y VPNC=y BRCM_NAND_JFFS2=y JFFS2LOG=y BCMFA=y XHCIMODE=y BWDPI=n \
                   TFAT=y HFS="tuxera" NTFS="tuxera" NFS=y IPSEC=n REPEATER=y DUALWAN=y DNSFILTER=y
else
export RT-AC56U := IPV6SUPP=y HTTPS=y ARM=y BCM57=y AUTODICT=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y \
                   SAMBA3=y MEDIASRV=y MODEM=y MODEMPIN=y BECEEM=y PARENTAL2=y ACCEL_PPTPD=y PRINTER=y GEOIP=y \
                   WEBDAV=y CLOUDSYNC=y USB="USB" GRO=y APP="installed" BUILD_NAME="RT-AC56U" PROXYSTA=y \
                   DNSMQ=y SHP=y NVRAM_64K=y RTAC56U=y BCMWL6=y BCMWL6A=y TUNEK="n" BCM5301X=y DISK_MONITOR=y \
                   TURBO=y BCM4352_5G=y LANWAN_LED=y OPTIMIZE_XBOX=y ODMPID=y BCMSMP=y DROPBOXCLIENT=y \
